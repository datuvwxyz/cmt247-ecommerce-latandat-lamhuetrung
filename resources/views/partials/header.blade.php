...
<<<<<<< HEAD
                        <div class="custom-select">
                            ...
                            <div class="select-items">
                                ...
                                <div><i class="fa-solid fa-microchip"></i>Card đồ họa</div>
                                <div><i class="fa-solid fa-display"></i>Màn hình</div>
                                <div><i class="fa-solid fa-print"></i>Máy in</div>
                                <div><i class="fa-solid fa-camera"></i>Camera</div>
                                <div><i class="fa-solid fa-headphones"></i>Loa</div>
                                <div><i class="fa-solid fa-desktop"></i>PC</div>
                                <div><i class="fa-solid fa-keyboard"></i>Phụ kiện</div>
                                <div><i class="fa-solid fa-wifi"></i>Mạng</div>
                                <div><i class="fa-solid fa-fan"></i>Máy lạnh</div>
                            </div>
                        </div>
